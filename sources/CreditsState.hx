...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Bambi Bass'],
			['Lucas', 'lucas', 'Coder/Animator/Charter (original maker of bambi sprites)', 'https://twitter.com/lucasdoestweet1', 'FFFFFF'],
			['syberyen', 'syberyen', 'Artist/said i could make this lmao', 'https://www.youtube.com/c/syberyenbruhmoment', 'FF0000'],
			['Biddle3', 'b3', 'Composer', 'https://twitter.com/Biddy312', 'FFFF00'],
			['CatDude_CD', 'catdude', 'Event Helper/Somehow made it popular lmao', 'https://twitter.com/cat_guy123', '0000FF'],
			[''],
			['OS Engine Team'],
			['weuz_', 'weuz', 'Main Programmer of OS Engine', 'https://twitter.com/notweuz_', '8633F2'],
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.pressed.CONTROL) {
			CoolUtil.browserLoad('https://discord.gg/WgWzubQSER');
		}
